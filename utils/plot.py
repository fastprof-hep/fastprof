...
parser.add_argument("-m", "--model-file", type=str  , required=True , help="Name of JSON file defining model", type=str)
parser.add_argument("-d", "--data-file" , type=str  , default=''    , help="Name of JSON file defining the dataset (optional, otherwise taken from model file)", type=str)
parser.add_argument("-a", "--asimov"    , type=float, default=None  , help="Fit an Asimov dataset for the specified POI value", type=float)
parser.add_argument("-p", "--poi-value" , type=float, required=True , help="POI initial value", type=float)
parser.add_argument("-r", "--poi-range" , type=str  , default='0,20', help="POI allowed range, in the form min,max", type=str)
...
parser.add_argument("-v", "--verbosity" , type=int  , default=0     , help="Verbosity level", type=int)
